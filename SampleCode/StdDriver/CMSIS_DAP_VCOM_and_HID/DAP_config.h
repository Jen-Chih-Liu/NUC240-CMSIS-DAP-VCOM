...
#define SWD_GPIO   	PA
#define SWD_SWCLK   PA0
#define SWD_SWDIO   PA1
#define PIN_SWCLK  	0
#define PIN_SWDIO  	1
...
{
    GPIO_SetMode(SWD_GPIO, MSK_SWCLK, GPIO_PMD_OUTPUT);
	  GPIO_SetMode(SWD_GPIO, MSK_SWDIO, GPIO_PMD_OUTPUT);
}
...
{
	GPIO_SetMode(SWD_GPIO, MSK_SWCLK, GPIO_PMD_INPUT);
	GPIO_SetMode(SWD_GPIO, MSK_SWDIO, GPIO_PMD_INPUT);
}
